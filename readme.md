...
## 4.知识图谱与大模型模块
1. 该模块包含两个子版块，即知识图谱与工业大模型。
2. 知识图谱版块可以实现图谱的前端可视化、图谱自然语言查询、基于大模型的NER与RE、图谱的管理与维护
3. 工业大模型版块可以实现多轮对话、对话列表管理等
4. 未在云端托管的大文件：neo4j文件、package文件夹（包含：jdk文件）
5. jdk版本：jdk-21.0.6

## 5.首页需要做对应的修改，由缺陷检测系统改为深度学习系统，readme文件需要系统性重写